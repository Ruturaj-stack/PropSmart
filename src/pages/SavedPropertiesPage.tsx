    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <div className="container py-8 flex-1">
                ...
                <p className="text-muted-foreground mb-8">Your personal collection of dream homes</p>
                ...
                {(loading || savedLoading) ? (
                    ...
                    <div className="rounded-lg border border-destructive bg-destructive/10 p-8 text-center">
                        <p className="text-destructive">Failed to load saved properties. Please try again later.</p>
                    </div>
                ) : properties.length === 0 ? (
