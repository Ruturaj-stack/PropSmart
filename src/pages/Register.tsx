    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-1/2 items-center justify-center bg-primary lg:flex">
        <div className="max-w-md px-12">
          ...
          <h2 className="mt-8 font-display text-3xl font-bold text-primary-foreground">Join PropSmart</h2>
          <p className="mt-3 text-primary-foreground/60">Create your account to get intelligent property recommendations tailored to you.</p>
        </div>
      </div>
