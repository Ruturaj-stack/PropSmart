...
import { mockProperties, LOCATIONS, PROPERTY_TYPES } from "@/data/properties";
...
const Recommendations = () => {
  ...
  const recommendations = getRecommendations(mockProperties, prefs, 8);
    ...
    <div className="min-h-screen">
      ...
      <div className="container py-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-display text-3xl font-bold text-foreground">Your Recommendations</h1>
            <p className="text-muted-foreground">Properties scored and ranked based on your preferences</p>
          </div>
        </div>
        ...
        <div className="mt-8 rounded-xl border border-border bg-card p-6 shadow-card">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            <div>
              <label className="mb-1.5 block text-xs font-medium text-muted-foreground">Min Budget</label>
              <input
                type="number"
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium text-muted-foreground">Max Budget</label>
              <input
                type="number"
        ...
        <div className="mt-6 flex flex-wrap gap-4 rounded-lg bg-secondary p-4 text-xs text-muted-foreground">
          <span className="font-medium text-secondary-foreground">Scoring:</span>
        ...
        <div className="mt-8">
          {recommendations.length === 0 ? (
            <div className="rounded-xl border border-border bg-card py-20 text-center">
              <p className="text-lg font-medium text-card-foreground">No matching properties</p>
              <p className="mt-1 text-sm text-muted-foreground">Try adjusting your preferences</p>
            </div>
          ) : (
            <>
